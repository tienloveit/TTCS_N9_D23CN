...
public enum ErrorCode {
    ...
    PROMOTION_MIN_ORDER(
            400, "Order amount does not meet minimum requirement for this promotion",
            HttpStatus.BAD_REQUEST),
    ...
    REFUND_WINDOW_EXPIRED(400, "Refund request window has expired (24 hours after payment)",
            HttpStatus.BAD_REQUEST),
